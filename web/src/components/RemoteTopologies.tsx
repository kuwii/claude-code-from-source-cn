...
const topologies: Topology[] = [
  {
    ...
    nodes: [
      { id: "cli", label: "本地 CLI" },
      { id: "env-api", label: "环境 API" },
      { id: "web", label: "Web 界面" },
    ],
    edges: [
      { from: "cli", to: "env-api", label: "注册" },
      { from: "env-api", to: "cli", label: "轮询任务" },
      { from: "cli", to: "web", label: "WS 读取 / HTTP 写入" },
    ],
    layout: "horizontal",
  },
  {
    ...
    nodes: [
      { id: "cli", label: "本地 CLI" },
      { id: "session-api", label: "会话 API" },
      { id: "web", label: "Web 界面" },
    ],
    edges: [
      { from: "cli", to: "session-api", label: "创建会话" },
      { from: "cli", to: "web", label: "SSE 读取 / CCR 写入" },
    ],
    layout: "horizontal",
  },
  {
    ...
    icon: "\u{1F517}",
    nodes: [
      { id: "client", label: "远程客户端" },
      { id: "server", label: "本地 CLI 服务器" },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "infra", label: "Anthropic 基础设施" },
      { id: "apis", label: "第三方 API" },
    ],
    edges: [
      { from: "container", to: "infra", label: "WS 隧道" },
      { from: "infra", to: "apis", label: "凭据注入" },
    ],
    layout: "horizontal",
  },
];
